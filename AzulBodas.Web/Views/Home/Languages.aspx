...
<head runat="server">
    ...
    <style type="text/css">
        ...
        #wrapper a, #wrapper img {float:left}
        ...
        #wrapper div {position:absolute;left:50%;top:50%;margin-left:-137px;margin-top:-52px}
    </style>
</head>
<body>
    <table id="wrapper">
      <tr>
         <td>
            <div>
                ...
                <img src="<%= Url.Content("~/Content/images/logo-plain.png") %>" alt="language" />
